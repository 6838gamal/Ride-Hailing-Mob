...
/// AppTypography — Complete Design System Typography
/// نظام الطباعة الكامل للتطبيق
class AppTypography {
  AppTypography._();

  // ─── Display Styles | أنماط العرض ────────────────────────────────────────
  ...
  static TextStyle get etaDisplay => GoogleFonts.inter(
        fontSize: 48,
  ...
  // Dark variants | النسخ الداكنة
  static TextStyle darkOf(TextStyle style) =>
